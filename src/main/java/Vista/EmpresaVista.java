...
public class EmpresaVista extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBoxPaisesEmpresa.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        ...
        jComboBoxAnioEmpresa.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        jComboBoxMesEmpresa.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        jComboBoxMesEmpresa.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11", "12" }));

        jLabel10.setText("dia");

        jComboBoxDiaEmpresa.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        jTableEmpresas.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
    ...
    public void mostrarTablaEmpresas(){
        ...
        for (int i = 0; i < this.empresaControlador.listarEmpresas().size(); i++) {
            ...
            data[i][2] = this.empresaControlador.listarEmpresas().get(i).getNombreFundador();
            data[i][3] = this.empresaControlador.listarEmpresas().get(i).getPais();
            data[i][4] = this.empresaControlador.listarEmpresas().get(i).getDireccion();
            data[i][5] = this.empresaControlador.listarEmpresas().get(i).getFechaFundacion();
